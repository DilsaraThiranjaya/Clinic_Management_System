...
/**
 * Custom UserDetailsService loading user credentials and authorities from UserRepository.
 */
@Service
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // Prefix role name with 'ROLE_' for standard Spring Security authority convention
